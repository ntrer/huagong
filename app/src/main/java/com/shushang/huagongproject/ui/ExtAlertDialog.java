package com.shushang.huagongproject.ui;
...
public class ExtAlertDialog {
    ...
    public static void showSureDlg3(Context context, String title, String msg, String btnTxt, boolean isCancelable, final IExtDlgClick onclickListener) {
        final AlertDialog dlg = new AlertDialog.Builder(context).create();
        dlg.show();
        dlg.setContentView(R.layout.ext_cancel_sure_dialog3);
        dlg.getWindow().setBackgroundDrawableResource(
                android.R.color.transparent);
        View titleLayout = dlg.findViewById(R.id.title_layout);
        TextView titleTxt = (TextView) dlg.findViewById(R.id.ext_dialog_title);
...
//        });
    ...
    public static void showSureDlg4(Context context, String title, String msg, String btnTxt, boolean isCancelable, final IExtDlgClick onclickListener) {
        final AlertDialog dlg = new AlertDialog.Builder(context).create();
        dlg.show();
        dlg.setContentView(R.layout.ext_cancel_sure_dialog3);
        dlg.getWindow().setBackgroundDrawableResource(
    ...
    public static void showEditDlg2(Context context, String title,String btnTxt, boolean isCancelable, final IExtDlgClick2 onclickListener) {
        final AlertDialog dlg = new AlertDialog.Builder(context).create();
        dlg.setView(new EditText(context));
        dlg.show();
        dlg.setContentView(R.layout.ext_edit_dialog);
