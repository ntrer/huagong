...
public class KeHuActivity extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener {
                            ...
                            if (response != null) {
                                try {
                                    ...
                                    if (yiXiangJin.getCode() == 0) {
                                        ...
                                        Toast.makeText(KeHuActivity.this, "" + yiXiangJin.getMessage(), Toast.LENGTH_SHORT).show();
                                        PreferencesUtils.putString(KeHuActivity.this, "token_id", null);
                                        startActivity(new Intent(KeHuActivity.this, LoginActivity.class));
                                        finish();
    ...
    private void showData(final List<KeHu.DataBean> data) {
        ...
        mKeHuGuanliAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                ...
                intent.putExtra("kehuId", data.get(position).getBuyerId());
                intent.putExtra("kehuName", data.get(position).getBuyerTitle());
