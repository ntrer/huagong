...
public class FaHuoDanGuanLiActivity extends BaseActivity {
    ...
    public int setLayout() {
        return R.layout.activity_fa_huo_dan_guan_li;
    }
...
//        startActivity(new Intent(getActivity(),CaiGouDingDanGuanLiActivity.class));
    ...
    @OnClick(R.id.jiahao)
    void startJiaHao(){
        startActivity(new Intent(this,XinZengFaHuoActivity.class));
    }
