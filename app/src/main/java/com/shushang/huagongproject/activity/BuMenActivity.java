...
import com.shushang.huagongproject.activity.adapter.BumenAdapter;
...
public class BuMenActivity extends BaseActivity {
    ...
    private  List<BuMen.DataBean> data=new ArrayList<>();
    ...
    public int setLayout() {
        return R.layout.activity_bu_men;
    }
    ...
    private void initData() {
        ...
        String url= BaseUrl.BASE_URL+"Department/GetDepartments";
        Log.d("BaseUrl",url);
        try {
            RestClient.builder()
                    .url(url)
                    .success(new ISuccess() {
                        ...
                        public void onSuccess(String response) {
                            if(response!=null){
                                ...
                                BuMen buMen = JSONUtil.fromJson(response, BuMen.class);
                                if(buMen.getCode()==0){
                                    mLoading.setVisibility(View.GONE);
                                    data = buMen.getData();
                                    showData(data);
                    ...
                    .failure(new IFailure() {
                        ...
                        public void onFailure() {
                            mLoading.setVisibility(View.GONE);
                            Toast.makeText(BuMenActivity.this, "获取数据错误了！！！！", Toast.LENGTH_SHORT).show();
                        }
                    }).error(new IError() {
                @Override
                public void onError(int code, String msg) {
                    mLoading.setVisibility(View.GONE);
                    Toast.makeText(BuMenActivity.this, ""+msg, Toast.LENGTH_SHORT).show();
                }
            })
                    .build()
                    .get();
    ...
    private void showData(final List<BuMen.DataBean> data) {
        mBumenAdapter=new BumenAdapter(R.layout.item_bumen, data);
        mRvRecyclerView.setAdapter(mBumenAdapter);
        mRvRecyclerView.scrollToPosition(0);
        mBumenAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                ...
                intent.setClass(BuMenActivity.this,ZhiWuActivity.class);
                startActivity(intent);
                PreferencesUtils.putString(BuMenActivity.this, "bumen_code", null);
                PreferencesUtils.putString(BuMenActivity.this, "bumen_name", null);
                isfinish="1";
                finish();
            }
        });
