...
public class KaiPiaoDanGuanLiActivity extends BaseActivity {
    ...
    public int setLayout() {
        return R.layout.activity_kai_piao_dan_guan_li;
    }
...
//        startActivity(new Intent(getActivity(),CaiGouDingDanGuanLiActivity.class));
    ...
    @OnClick(R.id.jiahao)
    void startJiaHao(){
        startActivity(new Intent(this,KaiPiaoDanActivity.class));
    }
