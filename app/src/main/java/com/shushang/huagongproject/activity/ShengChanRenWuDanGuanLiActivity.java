...
import com.shushang.huagongproject.activity.adapter.ShengChanRenWuDanAdapter;
...
public class ShengChanRenWuDanGuanLiActivity extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private List<ShengChanRenWuDan.DataBean> data=new ArrayList<>();
    private ShengChanRenWuDanAdapter mShengChanRenWuDanAdapter;
    ...
    private void getData() {
        ...
        String url = BaseUrl.BASE_URL+"JobOrder/GetJobOrders?tid="+BaseUrl.TOKEN;
        Log.d("BaseUrl", url);
        try {
            RestClient.builder()
                    .url(url)
                    .success(new ISuccess() {
                        ...
                        public void onSuccess(String response) {
                            ...
                            if (response != null) {
                                try {
                                    ShengChanRenWuDan yiXiangJin = JSONUtil.fromJson(response, ShengChanRenWuDan.class);
                                    if(yiXiangJin.getCode()==0){
                                        ...
                                        Toast.makeText(ShengChanRenWuDanGuanLiActivity.this, ""+yiXiangJin.getMessage(), Toast.LENGTH_SHORT).show();
                                        PreferencesUtils.putString(ShengChanRenWuDanGuanLiActivity.this,"token_id",null);
                                        startActivity(new Intent(ShengChanRenWuDanGuanLiActivity.this, LoginActivity.class));
                                        finish();
                                    }
    ...
    private void showData(final List<ShengChanRenWuDan.DataBean> data) {
        ...
        mShengChanRenWuDanAdapter = new ShengChanRenWuDanAdapter(R.layout.item_shengchanrenwudan, data);
        //重复执行动画
        mShengChanRenWuDanAdapter.isFirstOnly(false);
        mRvRecycleview.setAdapter(mShengChanRenWuDanAdapter);
        mShengChanRenWuDanAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                Intent intent=new Intent(ShengChanRenWuDanGuanLiActivity.this,ShenHeShengchandanActivity.class);
    ...
    public int setLayout() {
        return R.layout.activity_sheng_chan_ren_wu_dan_guan_li;
    }
...
//        startActivity(new Intent(getActivity(),CaiGouDingDanGuanLiActivity.class));
    ...
    @OnClick(R.id.jiahao)
    void startJiaHao(){
        startActivity(new Intent(this,XinZengShengChanRenWuActivity.class));
    }


    @Subscribe(threadMode = ThreadMode.MAIN)
    public void Event(MessageEvent messageEvent) {
        if(messageEvent.getMessage().equals("生产")){
            getData();
        }
